...
public class Controller {
    ...
    private void configureView() {
        ...
        /// 4.
        configureTab(userProfileTab, "Личный\nКабинет", "sample/images/user.png", userProfileContainer ,getClass().getResource("userprofile.fxml"), replaceBackgroundColorHandler);
        configureTab(settingsTab, "Настройки", "sample/images/settings.png", settingsContainer, getClass().getResource("settings.fxml"), replaceBackgroundColorHandler);
        configureTab(logoutTab, "Выйти", "sample/images/logout.png", null, null, logoutHandler);
